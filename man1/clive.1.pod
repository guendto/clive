...
that parsed the video stream URLs and used a third party command
to download the videos.

=head1 GETTING STARTED

See L</FILES> for an example configuration file. You should set at very
least L</--quvi> and L</--get-with> in your configuration file for
seamless use.
...
Similar but get the mp4_360p format (specific to YouTube) of the video.
